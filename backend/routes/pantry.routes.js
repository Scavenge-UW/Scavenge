...
router.put('/pantries/:pantry_id/reservations/:reservation_id', completeReservationAction);

// Mark a reservation as approved
router.put('/pantries/:pantry_id/reservations/approve/:reservation_id', approveReservationAction);

// Mark a reservation as cancelled
router.put('/pantries/:pantry_id/reservations/cancel/:reservation_id', cancelReservationAction);
