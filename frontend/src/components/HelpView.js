...
export default class HelpView extends Component {
    render() {
        return (
            <div className="container" style={{background: "#FFF", height: "150vh"}}>
               <h1 className="text-center" style={{paddingTop:"20px", fontFamily:"courier"}}>Help Page</h1>
               
               <div className="container mt-4">
                <h5 style={{fontFamily:"Courier"}}>Frequently Asked Questions</h5>
                <ul style={{fontFamily:"Courier"}}>
                ...
                <h5 style={{fontFamily:"Courier"}}>Contact Info</h5>
                <ul style={{fontFamily:"Courier"}}>
                ...
                <h5 style={{fontFamily:"Courier"}}>Current Features</h5>
                <ul style={{fontFamily:"Courier"}}>
                ...
                <h5 style={{fontFamily:"Courier"}}>Upcoming Features</h5>
                <ul style={{fontFamily:"Courier"}}>
